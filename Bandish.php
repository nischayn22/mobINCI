    ...
    <body>
        <div data-role="page" id="page1">
            ...
            <div data-role="content">
                ...
                <h3>
                    Bandish (Eastern Musical)
                </h3>
                <div>
                    <img style="width: 288px; height: 100px" allign="centre"src="Bandish.png" />
                </div>
                <div>
                    <h4>
                        <b>
                           The limelight, the stage, plethora of musical creativity - the old and the new, blending in perfect harmony to give sounds that resonate within your mind.
							<br/>* Event is scheduled to be held on 3rd Feb 2012.							
...
<input type="hidden" name="eventname" value="bandish" />               
